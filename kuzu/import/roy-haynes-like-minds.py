...
MERGE (release_c428e760a3e2:Release{ uuid: 'a933a25a-3ce5-453e-aa4e-c428e760a3e2' })
SET release_c428e760a3e2.name = 'Like Minds'
SET release_c428e760a3e2.country = 'US'
SET release_c428e760a3e2.date = '2003'
SET release_c428e760a3e2.format = 'Hybrid SACD'
SET release_c428e760a3e2.discode = 'SACD-1029-6'
SET release_c428e760a3e2.discogs = 'https://www.discogs.com/release/5465554'
SET release_c428e760a3e2.musicbrainz = 'http://musicbrainz.org/release/a933a25a-3ce5-453e-aa4e-c428e760a3e2'
SET release_c428e760a3e2.source = 'musicbrainz.org'
...
SET person_dabcde5dade7.allmusic = 'https://www.allmusic.com/artist/mn0000143439'
SET person_dabcde5dade7.discogs = 'https://www.discogs.com/artist/82811'
SET person_dabcde5dade7.imdb = 'https://www.imdb.com/name/nm9229858/'
SET person_dabcde5dade7.databases = ['https://rateyourmusic.com/artist/james_farber/credits/']
...
SET person_b1f20fcef5dc.databases = ['http://id.loc.gov/authorities/names/n81080891', 'https://catalogue.bnf.fr/ark:/12148/cb13892003b', 'https://d-nb.info/gnd/134341082', 'http://snaccooperative.org/ark:/99166/w64p1ghv', 'https://www.worldcat.org/identities/lccn-n81080891']
...
MERGE (label_46612304aca6:Label{ uuid: 'c5f3bc66-5e1e-47bf-8737-46612304aca6' })
SET label_46612304aca6.name= 'Concord Records'
...
SET perf_af0531a1f675.duration = '6:17'
...
SET perf_fe09eaecfc03.duration = '10:41'
...
SET perf_a0564c9640d8.duration = '6:33'
...
SET perf_bfa3ec107627.duration = '5:23'
...
// labels
MERGE (release_c428e760a3e2)-[:HAS_LABEL]->(label_935dbdbb598a)
MERGE (release_c428e760a3e2)-[:HAS_LABEL]->(label_46612304aca6)


// tracks
MERGE (release_c428e760a3e2)-[:HAS_TRACK {name: '1', sequence: 1}]->(perf_b636a6564ae5)
MERGE (release_c428e760a3e2)-[:HAS_TRACK {name: '2', sequence: 2}]->(perf_ffec9da58ff6)
MERGE (release_c428e760a3e2)-[:HAS_TRACK {name: '3', sequence: 3}]->(perf_af0531a1f675)
MERGE (release_c428e760a3e2)-[:HAS_TRACK {name: '4', sequence: 4}]->(perf_fe09eaecfc03)
MERGE (release_c428e760a3e2)-[:HAS_TRACK {name: '5', sequence: 5}]->(perf_eb42a3ac2549)
MERGE (release_c428e760a3e2)-[:HAS_TRACK {name: '6', sequence: 6}]->(perf_1ec6cbd5e2ab)
MERGE (release_c428e760a3e2)-[:HAS_TRACK {name: '7', sequence: 7}]->(perf_a0564c9640d8)
MERGE (release_c428e760a3e2)-[:HAS_TRACK {name: '8', sequence: 8}]->(perf_1c6fa5fcee0d)
MERGE (release_c428e760a3e2)-[:HAS_TRACK {name: '9', sequence: 9}]->(perf_bfa3ec107627)
MERGE (release_c428e760a3e2)-[:HAS_TRACK {name: '10', sequence: 10}]->(perf_0249c5d5914b)
...
MERGE (perf_b636a6564ae5)-[:HAS_PLACE { type: 'recorded at', begin_date: '1997-12-15', end_date: '1997-12-17' }]->(place_6e44f7dfcf98)
MERGE (perf_ffec9da58ff6)-[:HAS_PLACE { type: 'mixed at' }]->(place_d3f1bab1fdad)
MERGE (perf_ffec9da58ff6)-[:HAS_PLACE { type: 'recorded at', begin_date: '1997-12-15', end_date: '1997-12-17' }]->(place_6e44f7dfcf98)
MERGE (perf_af0531a1f675)-[:HAS_PLACE { type: 'mixed at' }]->(place_d3f1bab1fdad)
MERGE (perf_af0531a1f675)-[:HAS_PLACE { type: 'recorded at', begin_date: '1997-12-15', end_date: '1997-12-17' }]->(place_6e44f7dfcf98)
MERGE (perf_fe09eaecfc03)-[:HAS_PLACE { type: 'mixed at' }]->(place_d3f1bab1fdad)
MERGE (perf_fe09eaecfc03)-[:HAS_PLACE { type: 'recorded at', begin_date: '1997-12-15', end_date: '1997-12-17' }]->(place_6e44f7dfcf98)
MERGE (perf_eb42a3ac2549)-[:HAS_PLACE { type: 'mixed at' }]->(place_d3f1bab1fdad)
MERGE (perf_eb42a3ac2549)-[:HAS_PLACE { type: 'recorded at', begin_date: '1997-12-15', end_date: '1997-12-17' }]->(place_6e44f7dfcf98)
MERGE (perf_1ec6cbd5e2ab)-[:HAS_PLACE { type: 'mixed at' }]->(place_d3f1bab1fdad)
MERGE (perf_1ec6cbd5e2ab)-[:HAS_PLACE { type: 'recorded at', begin_date: '1997-12-15', end_date: '1997-12-17' }]->(place_6e44f7dfcf98)
MERGE (perf_a0564c9640d8)-[:HAS_PLACE { type: 'mixed at' }]->(place_d3f1bab1fdad)
MERGE (perf_a0564c9640d8)-[:HAS_PLACE { type: 'recorded at', begin_date: '1997-12-15', end_date: '1997-12-17' }]->(place_6e44f7dfcf98)
MERGE (perf_1c6fa5fcee0d)-[:HAS_PLACE { type: 'mixed at' }]->(place_d3f1bab1fdad)
MERGE (perf_1c6fa5fcee0d)-[:HAS_PLACE { type: 'recorded at', begin_date: '1997-12-15', end_date: '1997-12-17' }]->(place_6e44f7dfcf98)
MERGE (perf_bfa3ec107627)-[:HAS_PLACE { type: 'mixed at' }]->(place_d3f1bab1fdad)
MERGE (perf_bfa3ec107627)-[:HAS_PLACE { type: 'recorded at', begin_date: '1997-12-15', end_date: '1997-12-17' }]->(place_6e44f7dfcf98)
MERGE (perf_0249c5d5914b)-[:HAS_PLACE { type: 'mixed at' }]->(place_d3f1bab1fdad)
MERGE (perf_0249c5d5914b)-[:HAS_PLACE { type: 'recorded at', begin_date: '1997-12-15', end_date: '1997-12-17' }]->(place_6e44f7dfcf98)
