...
MERGE (release_6fa378294202:Release{ uuid: '94245de3-688f-4a10-b925-6fa378294202' })
SET release_6fa378294202.name = 'Sarah Vaughan With Clifford Brown'
SET release_6fa378294202.country = 'US'
SET release_6fa378294202.date = '1990-11-20'
SET release_6fa378294202.format = 'CD'
SET release_6fa378294202.discode = '8146412'
SET release_6fa378294202.discogs = 'https://www.discogs.com/release/3778807'
SET release_6fa378294202.musicbrainz = 'http://musicbrainz.org/release/94245de3-688f-4a10-b925-6fa378294202'
SET release_6fa378294202.source = 'musicbrainz.org'
...
MERGE (label_fa752750ae44:Label{ uuid: '1fc9f71a-8d08-4c02-ab13-fa752750ae44' })
SET label_fa752750ae44.name= 'PolyGram'

// performances

MERGE (perf_e40e366a2283:Performance{ uuid: '27bf94aa-a2df-412a-8832-e40e366a2283' })
SET perf_e40e366a2283.name = 'Lullaby of Birdland'
SET perf_e40e366a2283.duration = '4:00'
SET perf_e40e366a2283.begin_date = '1954-12-16'
SET perf_e40e366a2283.end_date = '1954-12-16'
SET perf_e40e366a2283.source = 'musicbrainz.org'
...
MERGE (perf_fcf73138c050:Performance{ uuid: '8381016a-fba1-4ab8-b7ae-fcf73138c050' })
SET perf_fcf73138c050.name = 'April in Paris'
SET perf_fcf73138c050.duration = '6:22'
SET perf_fcf73138c050.begin_date = '1954-12-18'
SET perf_fcf73138c050.end_date = '1954-12-18'
SET perf_fcf73138c050.source = 'musicbrainz.org'
...
// labels
MERGE (release_6fa378294202)-[:HAS_LABEL]->(label_fa752750ae44)


// tracks
MERGE (release_6fa378294202)-[:HAS_TRACK {name: '1', sequence: 1}]->(perf_e40e366a2283)
MERGE (release_6fa378294202)-[:HAS_TRACK {name: '2', sequence: 2}]->(perf_1fa9437cea92)
MERGE (release_6fa378294202)-[:HAS_TRACK {name: '3', sequence: 3}]->(perf_8849bcd91686)
MERGE (release_6fa378294202)-[:HAS_TRACK {name: '4', sequence: 4}]->(perf_8b1b8d05c196)
MERGE (release_6fa378294202)-[:HAS_TRACK {name: '5', sequence: 5}]->(perf_974ef6842862)
MERGE (release_6fa378294202)-[:HAS_TRACK {name: '6', sequence: 6}]->(perf_0d4ab9d8818b)
MERGE (release_6fa378294202)-[:HAS_TRACK {name: '7', sequence: 7}]->(perf_fcf73138c050)
MERGE (release_6fa378294202)-[:HAS_TRACK {name: '8', sequence: 8}]->(perf_91d9f082645e)
MERGE (release_6fa378294202)-[:HAS_TRACK {name: '9', sequence: 9}]->(perf_5b9d48ddcb6b)
MERGE (release_6fa378294202)-[:HAS_TRACK {name: '10', sequence: 10}]->(perf_e40e366a2283)
...
SET work_c96df644521c.musicbrainz = 'https://musicbrainz.org/work/151ac679-bdc7-4d5a-9325-c96df644521c'
...
MERGE (perf_e40e366a2283)-[:PERFORMANCE_OF]->(work_4411df467d9b)
MERGE (perf_5b9d48ddcb6b)-[:PERFORMANCE_OF]->(work_7c0d2793d8d9)
MERGE (perf_5b9d48ddcb6b)-[:PERFORMANCE_OF]->(work_7c0d2793d8d9)
MERGE (perf_91d9f082645e)-[:PERFORMANCE_OF]->(work_f50508027c99)
MERGE (perf_fcf73138c050)-[:PERFORMANCE_OF]->(work_4d4f5066e485)
...
// place relationships
MERGE (perf_e40e366a2283)-[:HAS_PLACE { type: 'recorded in', begin_date: '1954-12-16', end_date: '1954-12-16' }]->(place_decbb365c07f)
...
MERGE (perf_fcf73138c050)-[:HAS_PLACE { type: 'recorded in', begin_date: '1954-12-18', end_date: '1954-12-18' }]->(place_decbb365c07f)
...
MERGE (person_8f221f658ef3)-[:PARTICIPATED_IN { roles: ['musician'], instruments: ['double bass'] }]->(perf_e40e366a2283)
MERGE (person_eab1269c7ba8)-[:PARTICIPATED_IN { roles: ['musician'], instruments: ['trumpet'] }]->(perf_e40e366a2283)
MERGE (person_6f0a331cc1ca)-[:PARTICIPATED_IN { roles: ['musician'], instruments: ['drums (drum set)'] }]->(perf_e40e366a2283)
MERGE (person_beee70c5e271)-[:PARTICIPATED_IN { roles: ['musician'], instruments: ['piano'] }]->(perf_e40e366a2283)
MERGE (person_022409fbce60)-[:PARTICIPATED_IN { roles: ['musician'], instruments: ['flute'] }]->(perf_e40e366a2283)
MERGE (person_209e4eaf1b70)-[:PARTICIPATED_IN { roles: ['musician'], instruments: ['tenor saxophone', 'saxophone'] }]->(perf_e40e366a2283)
MERGE (person_c85fad20da55)-[:PARTICIPATED_IN { roles: ['singer', 'singer'] }]->(perf_e40e366a2283)
...
MERGE (person_8f221f658ef3)-[:PARTICIPATED_IN { roles: ['musician'], instruments: ['double bass'] }]->(perf_fcf73138c050)
MERGE (person_eab1269c7ba8)-[:PARTICIPATED_IN { roles: ['musician'], instruments: ['trumpet'] }]->(perf_fcf73138c050)
MERGE (person_6f0a331cc1ca)-[:PARTICIPATED_IN { roles: ['musician'], instruments: ['drums (drum set)'] }]->(perf_fcf73138c050)
MERGE (person_022409fbce60)-[:PARTICIPATED_IN { roles: ['musician'], instruments: ['flute'] }]->(perf_fcf73138c050)
MERGE (person_209e4eaf1b70)-[:PARTICIPATED_IN { roles: ['musician'], instruments: ['tenor saxophone'] }]->(perf_fcf73138c050)
MERGE (person_c85fad20da55)-[:PARTICIPATED_IN { roles: ['singer'] }]->(perf_fcf73138c050)
